...
def generate_full_report(
    ...
    prompt = (
        ...
        "write a comprehensive, insightful report for the platform owner.\n\n"
        "Structure your report with these sections:\n"
        "1. **Executive Summary** — 3-5 key findings with concrete numbers\n"
        "2. **Usage Patterns** — Activity trends, session behavior, peak usage\n"
        "3. **Cost & Efficiency** — Token usage, cache performance, model mix optimization\n"
        "4. **Agent & Skill Ecosystem** — Which are valuable, which are dead weight\n"
        "5. **Configuration Health** — Quality issues, complexity, improvement areas\n"
        "6. **Action Plan** — Top 5 prioritized recommendations with expected impact\n\n"
        "Guidelines:\n"
        "- Be specific and data-driven — cite numbers from the data\n"
        "- Highlight surprising or concerning patterns\n"
